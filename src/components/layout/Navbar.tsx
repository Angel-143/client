                  ...
                  {userMenuOpen && (
                    <>
                      ...
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: 8 }}
                        className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-800 py-2 z-50"
                      >
          ...
          >
            <div className="px-4 py-4 space-y-1">
              ...
              {session && (
                <button
                  onClick={handleSignOut}
                  className="flex items-center gap-2 px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 w-full rounded-lg"
                >
                  <LogOut size={16} /> Sign Out
                </button>
              )}
