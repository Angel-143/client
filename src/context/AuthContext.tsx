...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const loadProfile = async (userId: string) => {
    ...
    const poll = async () => {
      ...
      if (data) { setProfile(data as Profile); setLoading(false); return }
  ...
  return (
    <AuthContext.Provider value={{ session, profile, loading, isAdmin: profile?.role === 'admin', signUp, signIn, signOut }}>
      {children}
