            ...
            {orders.map((o) => (
              <div key={o.id} className="flex items-center justify-between p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-slate-900 dark:text-white">{o.project?.title ?? 'Project'}</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold text-slate-900 dark:text-white">{formatPrice(o.amount)}</span>
                </div>
              </div>
            ))}
          </div>
              ...
              <Link key={f.id} to={`/projects/${f.project?.slug}`} className="card-hover group p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="truncate text-sm font-semibold text-slate-900 dark:text-white">{f.project?.title}</p>
                    <p className="text-xs text-slate-500">{f.project?.category?.name}</p>
                  </div>
