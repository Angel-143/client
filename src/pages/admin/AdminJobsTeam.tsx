            ...
            {jobs.map((j) => (
              <div key={j.id} className="flex items-center justify-between p-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500">{j.department} · {j.location} · {j.employment_type}</p>
                </div>
            ...
            {members.map((m) => (
              <div key={m.id} className="card p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-slate-900 dark:text-white">{m.full_name}</p>
