        ...
        <div className="container-page pt-16 pb-20 sm:pt-20 lg:pt-28 lg:pb-28">
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="lg:col-span-7 lg:pt-6">
              ...
              >
                MyClientWork is a curated marketplace of premium source code for developers.
                Buy full-stack apps, dashboards, templates, and AI tools — deploy in minutes, not months.
              </motion.p>
              ...
              >
                <span className="flex items-center gap-1.5">
                  <ShieldCheck size={15} className="text-success-500" /> Secure checkout
                </span>
                <span className="flex items-center gap-1.5">
                  <Zap size={15} className="text-accent-500" /> Instant access
                </span>
                <span className="flex items-center gap-1.5">
                  <RefreshCw size={15} className="text-warning-500" /> Lifetime updates
                </span>
              </motion.div>
            </div>

            {/* Right: hero panel (5/12) — abstract preview */}
            <motion.div
              ...
              <div className="relative">
                ...
                <div className="relative rounded-2xl border border-slate-200/80 bg-white/90 p-5 shadow-card backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-900/80">
                  <div className="mb-4 flex items-center gap-2">
                    ...
                    <span className="ml-3 inline-flex items-center gap-1 rounded-md bg-slate-100 px-2 py-0.5 text-[10px] font-medium text-slate-500 dark:bg-slate-800 dark:text-slate-400">
                      <Code2 size={10} /> myclientwork.dev
                    </span>
                  </div>
                  ...
                  <div className="mt-4 flex items-center justify-between rounded-xl bg-gradient-to-r from-brand-600 to-violet-600 px-4 py-2.5 text-white">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs text-white/80">/ 5 · 2,400+ sales</span>
                    </div>
                    <TrendingUp size={16} />
                  </div>
                </div>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-slate-700 dark:text-slate-200">Code reviewed</span>
                  </div>
                </motion.div>
              </div>
            </motion.div>
