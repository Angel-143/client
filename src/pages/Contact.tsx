    ...
    <div className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-brand-50/50 to-white dark:from-brand-950/20 dark:to-gray-950 py-20">
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-brand-200/30 dark:bg-brand-900/20 rounded-full blur-3xl" />
        </div>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white tracking-tight">
              ...
              <span className="bg-gradient-to-r from-brand-600 to-blue-500 bg-clip-text text-transparent">project</span>
            </h1>
            <p className="mt-6 text-lg text-gray-600 dark:text-gray-400 leading-relaxed max-w-2xl mx-auto">
              Have a question or need a custom project? We're here to help. Reach out and we'll get back to you within 24 hours.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {infoCards.map((card, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                >
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
              className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8 shadow-sm"
            >
            ...
            >
              <div className="bg-gradient-to-br from-brand-600 to-brand-800 rounded-2xl p-6 text-white relative overflow-hidden">
                ...
                <p className="text-brand-100 text-sm mt-1">We typically respond within 24 hours during business days.</p>
              </div>
                ...
                <div className="flex gap-2">
                  {['GitHub', 'Twitter', 'LinkedIn'].map((social) => (
                    <a
                      key={social}
                      href="#"
                      className="flex-1 text-center text-xs font-medium px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-brand-600 hover:text-white transition-all"
                    >
                      {social}
                    </a>
                  ))}
