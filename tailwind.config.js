  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        card: '0 4px 6px -1px rgba(15, 23, 42, 0.05), 0 12px 32px -8px rgba(15, 23, 42, 0.10)',
        glow: '0 0 0 1px rgba(20, 184, 166, 0.12), 0 8px 28px -6px rgba(20, 184, 166, 0.30)',
        warm: '0 8px 32px -8px rgba(245, 158, 11, 0.25)',
      },
      backgroundImage: {
        'grid-light':
